# Contributing to ember-codemod-template-tag

Open source projects like `ember-codemod-template-tag` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your GitHub handle>/ember-codemod-template-tag.git
    ```

1. Change directory.

    ```sh
    cd ember-codemod-template-tag
    ```
